...
def inference(args, model, mode, test_save_path=None):
    db_test = Synapse_dataset(base_dir=args.volume_path, split=mode, list_dir=args.list_dir)
    ...
    return "Testing Finished!", performance
...
if __name__ == "__main__":
    ...
    # if True:
        ...
        test_save_path = None
    inference(args, net, "test_vol", test_save_path)
